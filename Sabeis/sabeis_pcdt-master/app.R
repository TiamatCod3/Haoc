...
ui <- dashboardPage(
  dashboardHeader(
    ...
    tags$li(a(href = 'ftp://ftp.datasus.gov.br/',
              icon('database'), title = 'FTP DataSUS',
              style = 'font-size: 20px'),
            class = 'dropdown'),
    tags$li(a(href = 'https://github.com/labxss/sabeis_pcdt',
...
server <- function(input, output) {
  ...
  td_pcdt_cid = read.csv(file = 'dataset/csv/db_sabeis.td_pcdt_cid.csv')
  tf_pcdt = subset(read.csv(file = 'dataset/csv/db_sabeis.tf_pcdt.csv'), sg_uf == 'BR')

  tf_pcdt_doenca_trimestre     = read.csv(file = 'dataset/csv/db_sabeis.tf_pcdt_doenca_trimestre.csv')
  tf_pcdt_estabelecimento      = read.csv(file = 'dataset/csv/db_sabeis.tf_pcdt_estabelecimento.csv')
  tf_pcdt_municipio_residencia = read.csv(file = 'dataset/csv/db_sabeis.tf_pcdt_municipio_residencia.csv')
  tf_pcdt_paciente             = read.csv(file = 'dataset/csv/db_sabeis.tf_pcdt_paciente.csv')
  ...
  tf_pcdt_produto_ano          = read.csv(file = 'dataset/csv/db_sabeis.tf_pcdt_produto_ano_outros.csv')
  ...
  tf_pcdt_municipio_residencia=read.csv(file="dataset/csv/db_sabeis.tf_pcdt_municipio_residencia_cobertura.csv")


  shp <- readOGR("dataset/map/", "BRUFE250GC_SIR", stringsAsFactors=FALSE, encoding="UTF-8")
  tf_pcdt_estabelecimento_uf=read.csv(file="dataset/csv/db_sabeis.tf_pcdt_estabelecimento_uf.csv")
  ...
  tf_pcdt_medicamento_trimestre = read.csv(file="dataset/csv/db_sabeis.tf_pcdt_medicamento_trimestre.csv")
  td_pcdt_abrev  = read.csv(file="dataset/csv/db_sabeis.td_pcdt_abrev.csv")
  td_trimestre = read.csv(file="dataset/csv/td_trimestre.csv")
  td_trimestre.plot = read.csv(file="dataset/csv/td_trimestre.plot.csv")
  ...
  tf_troca = read.csv(file="dataset/csv/db_sabeis.tf_troca.csv")
  ...
  tf_procedimento_paciente_tempo=
    read.csv(
      file="dataset/csv/db_sabeis.tf_procedimento_paciente_tempo.csv"
    )
...
# rsconnect::deployApp('/home/ferre/Dropbox/sabeis/release20191218/', appTitle = "SABEIS - PCDT", appName = "sabeis_pcdt", appPrimaryDoc = "pcdt.R")


# R -e "shiny::runApp('/home/ferre/Dropbox/sabeis/source/pcdt.R')"
